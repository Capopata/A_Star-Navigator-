...
class App:
    def __init__(self, root):
        ...
        self.btn_start = tk.Button(ctrl, text="Giải bằng A*", command=self.start_a_star)
        self.btn_start.pack(fill=tk.X, pady=5)

        self.btn_start2 = tk.Button(ctrl, text="Giải bằng cái mẹ j đấy", command=self.start_what_ever)
        self.btn_start2.pack(fill=tk.X, pady=5)
